...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  final ModelApi _api = ModelApi("https://702a-34-83-47-47.ngrok-free.app/");
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                 // _imageSourceOption(icon: Icons.camera_alt_rounded, label: "Camera", color: Colors.lightGreen, onTap: () async {Navigator.pop(context);if (multi) {final pickedFile = await picker.pickImage(source: ImageSource.camera, imageQuality: 90,);if (pickedFile != null) {_processMultiPickedImage([pickedFile]);}} else {final pickedFile = await picker.pickImage(source: ImageSource.camera, imageQuality: 90,);_processSinglePickedImage(pickedFile);}},),
                  _imageSourceOption(
...
class ModelApi {
  ...
  ModelApi(this.baseUrl);               //constructor
